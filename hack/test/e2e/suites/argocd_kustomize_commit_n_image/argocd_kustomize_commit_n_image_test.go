...
package argocd_kustomize_commit_n_image_test
...
func TestArgocdKustomizeCommitNImage(t *testing.T) {
	feature := features.New("argocd-kustomize-commit-n-image")

	project := "kargo-argocd-kustomize-commit-image"
