...
func feature() features.Feature {
	...
	feature.Setup(func(ctx context.Context, t *testing.T, cfg *envconf.Config) context.Context {
		...
		if err != nil {
			t.Fatalf("cannot get context.http_endpoint from env; "+
				"configure it to an HTTP endpoint that returns 2xx to a POST: %v", err)
		}
	...
	feature.Assess("http step posts to the configured endpoint",
