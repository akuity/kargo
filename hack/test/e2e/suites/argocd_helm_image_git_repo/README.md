# argocd_helm_image_git_repo

Argo CD driven, Helm image-only with a Git-repo source. New image versions are mixed into each stage's `Application` via Helm parameters.
