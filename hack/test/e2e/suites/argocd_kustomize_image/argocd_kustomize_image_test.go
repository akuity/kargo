...
package argocd_kustomize_image_test
...
func TestArgocdKustomizeImage(t *testing.T) {
	feature := features.New("argocd-kustomize-image")

	project := "kargo-argocd-kustomize-image"
	origin := "kargo-demo"
	...
	feature.Setup(func(ctx context.Context, t *testing.T, cfg *envconf.Config) context.Context {
		...
		// The Warehouse subscribes to an image, so only the PromotionTask's
		// gitRepo var needs to point at the fork.
