...
/**
 * @generated from rpc akuity.io.kargo.service.v1alpha1.KargoService.QueryFreights
 */
export const queryFreights = createQueryService({
  service: {
    methods: {
      queryFreights: {
        name: "QueryFreights",
        kind: MethodKind.Unary,
        I: QueryFreightsRequest,
        O: QueryFreightsResponse,
      },
    },
    typeName: "akuity.io.kargo.service.v1alpha1.KargoService",
  },
