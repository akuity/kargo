...
import type { ObjectReference, PodTemplateSpec } from "../../core/v1/generated_pb";
import { file_k8s_io_api_core_v1_generated } from "../../core/v1/generated_pb";
import type { LabelSelector, ListMeta, ObjectMeta, Time } from "../../../apimachinery/pkg/apis/meta/v1/generated_pb";
...
export const file_k8s_io_api_batch_v1_generated: GenFile = /*@__PURE__*/
  fileDesc("", [file_k8s_io_api_core_v1_generated, file_k8s_io_apimachinery_pkg_apis_meta_v1_generated, file_k8s_io_apimachinery_pkg_runtime_generated, file_k8s_io_apimachinery_pkg_runtime_schema_generated]);
 ...
 */
export type CronJob = Message<"k8s.io.api.batch.v1.CronJob"> & {
  /**
 ...
 */
export type CronJobList = Message<"k8s.io.api.batch.v1.CronJobList"> & {
  /**
...
/**
 * Describes the message k8s.io.api.batch.v1.CronJobList.
 * Use `create(CronJobListSchema)` to create a new message.
 */
export const CronJobListSchema: GenMessage<CronJobList> = /*@__PURE__*/
  messageDesc(file_k8s_io_api_batch_v1_generated, 1);
 ...
 */
export type CronJobSpec = Message<"k8s.io.api.batch.v1.CronJobSpec"> & {
  /**
...
/**
 * Describes the message k8s.io.api.batch.v1.CronJobSpec.
 * Use `create(CronJobSpecSchema)` to create a new message.
 */
export const CronJobSpecSchema: GenMessage<CronJobSpec> = /*@__PURE__*/
  messageDesc(file_k8s_io_api_batch_v1_generated, 2);
 ...
 */
export type CronJobStatus = Message<"k8s.io.api.batch.v1.CronJobStatus"> & {
  /**
...
/**
 * Describes the message k8s.io.api.batch.v1.CronJobStatus.
 * Use `create(CronJobStatusSchema)` to create a new message.
 */
export const CronJobStatusSchema: GenMessage<CronJobStatus> = /*@__PURE__*/
  messageDesc(file_k8s_io_api_batch_v1_generated, 3);
 ...
 */
export type Job = Message<"k8s.io.api.batch.v1.Job"> & {
  /**
   * Standard object's metadata.
   * More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
   * +optional
...
/**
 * Describes the message k8s.io.api.batch.v1.Job.
 * Use `create(JobSchema)` to create a new message.
 */
export const JobSchema: GenMessage<Job> = /*@__PURE__*/
  messageDesc(file_k8s_io_api_batch_v1_generated, 4);
 ...
 */
export type JobCondition = Message<"k8s.io.api.batch.v1.JobCondition"> & {
  /**
 ...
 */
export type JobList = Message<"k8s.io.api.batch.v1.JobList"> & {
  /**
   * Standard list metadata.
   * More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
   * +optional
 ...
 */
export type JobSpec = Message<"k8s.io.api.batch.v1.JobSpec"> & {
  /**
 ...
 */
export type JobStatus = Message<"k8s.io.api.batch.v1.JobStatus"> & {
  /**
 ...
 */
export type JobTemplateSpec = Message<"k8s.io.api.batch.v1.JobTemplateSpec"> & {
  /**
...
/**
 * Describes the message k8s.io.api.batch.v1.JobTemplateSpec.
 * Use `create(JobTemplateSpecSchema)` to create a new message.
 */
export const JobTemplateSpecSchema: GenMessage<JobTemplateSpec> = /*@__PURE__*/
  messageDesc(file_k8s_io_api_batch_v1_generated, 9);
 ...
 */
export type PodFailurePolicy = Message<"k8s.io.api.batch.v1.PodFailurePolicy"> & {
  /**
...
/**
 * Describes the message k8s.io.api.batch.v1.PodFailurePolicy.
 * Use `create(PodFailurePolicySchema)` to create a new message.
 */
export const PodFailurePolicySchema: GenMessage<PodFailurePolicy> = /*@__PURE__*/
  messageDesc(file_k8s_io_api_batch_v1_generated, 10);
 ...
 */
export type PodFailurePolicyOnExitCodesRequirement = Message<"k8s.io.api.batch.v1.PodFailurePolicyOnExitCodesRequirement"> & {
  /**
...
/**
 * Describes the message k8s.io.api.batch.v1.PodFailurePolicyOnExitCodesRequirement.
 * Use `create(PodFailurePolicyOnExitCodesRequirementSchema)` to create a new message.
 */
export const PodFailurePolicyOnExitCodesRequirementSchema: GenMessage<PodFailurePolicyOnExitCodesRequirement> = /*@__PURE__*/
  messageDesc(file_k8s_io_api_batch_v1_generated, 11);
 ...
 */
export type PodFailurePolicyOnPodConditionsPattern = Message<"k8s.io.api.batch.v1.PodFailurePolicyOnPodConditionsPattern"> & {
  /**
...
/**
 * Describes the message k8s.io.api.batch.v1.PodFailurePolicyOnPodConditionsPattern.
 * Use `create(PodFailurePolicyOnPodConditionsPatternSchema)` to create a new message.
 */
export const PodFailurePolicyOnPodConditionsPatternSchema: GenMessage<PodFailurePolicyOnPodConditionsPattern> = /*@__PURE__*/
  messageDesc(file_k8s_io_api_batch_v1_generated, 12);
 ...
 */
export type PodFailurePolicyRule = Message<"k8s.io.api.batch.v1.PodFailurePolicyRule"> & {
  /**
...
/**
 * Describes the message k8s.io.api.batch.v1.PodFailurePolicyRule.
 * Use `create(PodFailurePolicyRuleSchema)` to create a new message.
 */
export const PodFailurePolicyRuleSchema: GenMessage<PodFailurePolicyRule> = /*@__PURE__*/
 ...
 */
export type UncountedTerminatedPods = Message<"k8s.io.api.batch.v1.UncountedTerminatedPods"> & {
  /**
...
/**
 * Describes the message k8s.io.api.batch.v1.UncountedTerminatedPods.
