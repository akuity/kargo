...
export type CreateConfigMapRequest = Message<"akuity.io.kargo.service.v1alpha1.CreateConfigMapRequest"> & {
   ...
   *
   * @generated from field: k8s.io.api.core.v1.ConfigMap config_map = 2;
   */
  configMap?: ConfigMap;
};
