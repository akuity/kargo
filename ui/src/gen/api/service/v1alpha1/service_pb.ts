...
import type { ClusterConfig, ClusterPromotionTask, Freight, FreightCollection, FreightRequest, Health, Project, ProjectConfig, Promotion, PromotionReference, PromotionTask, Stage, Warehouse } from "../../v1alpha1/generated_pb";
...
import type { Condition, ObjectMeta } from "../../../k8s.io/apimachinery/pkg/apis/meta/v1/generated_pb";
...
export type GetStageHealthOutputsResponse = Message<"akuity.io.kargo.service.v1alpha1.GetStageHealthOutputsResponse"> & {
   ...
   *
   * @generated from field: map<string, bytes> health_outputs = 1;
   */
  healthOutputs: { [key: string]: Uint8Array };
};
 ...
 *
 * @generated from message akuity.io.kargo.service.v1alpha1.StageSummary
 */
export type StageSummary = Message<"akuity.io.kargo.service.v1alpha1.StageSummary"> & {
  /**
   ...
   *
   * @generated from field: optional akuity.io.kargo.service.v1alpha1.StageSpecSummary spec = 2;
   */
  spec?: StageSpecSummary;

  /**
   * status contains the subset of StageStatus fields needed by list/graph views.
   *
   * @generated from field: optional akuity.io.kargo.service.v1alpha1.StageStatusSummary status = 3;
   */
  status?: StageStatusSummary;
};

/**
 * Describes the message akuity.io.kargo.service.v1alpha1.StageSummary.
 ...
 *
 * @generated from message akuity.io.kargo.service.v1alpha1.StageSpecSummary
 */
export type StageSpecSummary = Message<"akuity.io.kargo.service.v1alpha1.StageSpecSummary"> & {
  /**
   ...
   *
   * @generated from field: repeated github.com.akuity.kargo.api.v1alpha1.FreightRequest requested_freight = 2;
   */
   ...
   *
   * @generated from field: int32 promotion_step_count = 3;
   */
   ...
   *
   * @generated from field: bool has_verification = 4;
   */
  hasVerification: boolean;
};

/**
 * Describes the message akuity.io.kargo.service.v1alpha1.StageSpecSummary.
 * Use `create(StageSpecSummarySchema)` to create a new message.
 */
export const StageSpecSummarySchema: GenMessage<StageSpecSummary> = /*@__PURE__*/
 ...
 * ListStageSummaries. See StageSummary for the motivation.
 *
 * @generated from message akuity.io.kargo.service.v1alpha1.StageStatusSummary
 */
export type StageStatusSummary = Message<"akuity.io.kargo.service.v1alpha1.StageStatusSummary"> & {
  /**
   ...
   *
   * @generated from field: string last_handled_refresh = 2;
   */
   ...
   *
   * @generated from field: optional github.com.akuity.kargo.api.v1alpha1.FreightCollection current_freight = 3;
   */
   ...
   *
   * @generated from field: optional github.com.akuity.kargo.api.v1alpha1.PromotionReference current_promotion = 4;
   */
   ...
   *
   * @generated from field: optional github.com.akuity.kargo.api.v1alpha1.PromotionReference last_promotion = 5;
   */
   ...
   *
   * @generated from field: optional github.com.akuity.kargo.api.v1alpha1.Health health = 6;
   */
  health?: Health;
   ...
   *
   * @generated from field: bool auto_promotion_enabled = 8;
   */
  autoPromotionEnabled: boolean;
};

/**
 * Describes the message akuity.io.kargo.service.v1alpha1.StageStatusSummary.
 * Use `create(StageStatusSummarySchema)` to create a new message.
 */
export const StageStatusSummarySchema: GenMessage<StageStatusSummary> = /*@__PURE__*/
 ...
 * within a project.
 *
 * @generated from message akuity.io.kargo.service.v1alpha1.ListStageSummariesRequest
 */
export type ListStageSummariesRequest = Message<"akuity.io.kargo.service.v1alpha1.ListStageSummariesRequest"> & {
  /**
...
/**
 * Describes the message akuity.io.kargo.service.v1alpha1.ListStageSummariesRequest.
 * Use `create(ListStageSummariesRequestSchema)` to create a new message.
 */
export const ListStageSummariesRequestSchema: GenMessage<ListStageSummariesRequest> = /*@__PURE__*/
 ...
 *
 * @generated from message akuity.io.kargo.service.v1alpha1.ListStageSummariesResponse
 */
export type ListStageSummariesResponse = Message<"akuity.io.kargo.service.v1alpha1.ListStageSummariesResponse"> & {
  /**
   * stageSummaries is the list of StageSummary objects found in the project.
   *
   * @generated from field: repeated akuity.io.kargo.service.v1alpha1.StageSummary stage_summaries = 1;
   */
...
/**
 * Describes the message akuity.io.kargo.service.v1alpha1.ListStageSummariesResponse.
 * Use `create(ListStageSummariesResponseSchema)` to create a new message.
 */
export const ListStageSummariesResponseSchema: GenMessage<ListStageSummariesResponse> = /*@__PURE__*/
 ...
 *
 * @generated from message akuity.io.kargo.service.v1alpha1.WatchStageSummariesRequest
 */
export type WatchStageSummariesRequest = Message<"akuity.io.kargo.service.v1alpha1.WatchStageSummariesRequest"> & {
  /**
...
/**
 * Describes the message akuity.io.kargo.service.v1alpha1.WatchStageSummariesRequest.
 * Use `create(WatchStageSummariesRequestSchema)` to create a new message.
 */
export const WatchStageSummariesRequestSchema: GenMessage<WatchStageSummariesRequest> = /*@__PURE__*/
  messageDesc(file_api_service_v1alpha1_service, 43);

/**
 * WatchStageSummariesResponse contains stage summary change notifications.
 *
 * @generated from message akuity.io.kargo.service.v1alpha1.WatchStageSummariesResponse
 */
export type WatchStageSummariesResponse = Message<"akuity.io.kargo.service.v1alpha1.WatchStageSummariesResponse"> & {
  /**
   * stageSummary is the StageSummary for the Stage that changed.
   *
   * @generated from field: optional akuity.io.kargo.service.v1alpha1.StageSummary stage_summary = 1;
   */
...
/**
 * Describes the message akuity.io.kargo.service.v1alpha1.WatchStageSummariesResponse.
 * Use `create(WatchStageSummariesResponseSchema)` to create a new message.
 */
export const WatchStageSummariesResponseSchema: GenMessage<WatchStageSummariesResponse> = /*@__PURE__*/
...
export const KargoService: GenService<{
  ...
  listStageSummaries: {
    methodKind: "unary";
    input: typeof ListStageSummariesRequestSchema;
    output: typeof ListStageSummariesResponseSchema;
  },
  /**
   ...
   *
   * @generated from rpc akuity.io.kargo.service.v1alpha1.KargoService.WatchStageSummaries
   */
  watchStageSummaries: {
    methodKind: "server_streaming";
    input: typeof WatchStageSummariesRequestSchema;
    output: typeof WatchStageSummariesResponseSchema;
  },
  /**
