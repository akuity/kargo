...
export const createProjectRole = async (
  project: string,
  createProjectRoleBody: CreateProjectRoleBody,
  options?: RequestInit
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { project: string; data: CreateProjectRoleBody },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type CreateProjectRoleMutationResult = NonNullable<
  Awaited<ReturnType<typeof createProjectRole>>
>;
export type CreateProjectRoleMutationBody = CreateProjectRoleBody;
...
export const getUpdateRoleMutationOptions = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { project: string; role: string; data: UpdateRoleBody },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { project: string; role: string; data: CreateAPITokenRequest },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { role: string; data: CreateAPITokenRequest },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
