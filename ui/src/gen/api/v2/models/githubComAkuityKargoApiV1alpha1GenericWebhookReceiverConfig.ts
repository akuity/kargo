 ...
 */
import type { GithubComAkuityKargoApiV1alpha1GenericWebhookAction } from './githubComAkuityKargoApiV1alpha1GenericWebhookAction';
import type { V1LocalObjectReference } from './v1LocalObjectReference';

export interface GithubComAkuityKargoApiV1alpha1GenericWebhookReceiverConfig {
  /** Actions is a list of actions to be performed when a webhook event is received.

+kubebuilder:validation:MinItems=1 */
  actions?: GithubComAkuityKargoApiV1alpha1GenericWebhookAction[];
