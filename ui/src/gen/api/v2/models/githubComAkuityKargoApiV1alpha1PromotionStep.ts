...
export interface GithubComAkuityKargoApiV1alpha1PromotionStep {
...
considered to have failed. */
  ...
  retry?: GithubComAkuityKargoApiV1alpha1PromotionStepRetry;
  /** Task is a reference to a PromotionTask that should be inflated into a
Promotion when it is built from a PromotionTemplate. */
  task?: GithubComAkuityKargoApiV1alpha1PromotionTaskReference;
