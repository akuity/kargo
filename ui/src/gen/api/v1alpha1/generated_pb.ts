...
export type TargetOwnership = Message<"github.com.akuity.kargo.api.v1alpha1.TargetOwnership"> & {
   ...
   *
   * @generated from field: optional string health = 4;
   */
  health: string;
};
