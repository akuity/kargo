...
export type StageSpec = Message<"github.com.akuity.kargo.api.v1alpha1.StageSpec"> & {
   ...
   * +optional
   *
   * @generated from field: optional k8s.io.apimachinery.pkg.apis.meta.v1.LabelSelector targetSelector = 8;
   */
 ...
 *
 * @generated from message github.com.akuity.kargo.api.v1alpha1.TargetPromotion
 */
export type TargetPromotion = Message<"github.com.akuity.kargo.api.v1alpha1.TargetPromotion"> & {
  /**
   * @generated from field: optional k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMeta metadata = 1;
   */
  metadata?: ObjectMeta;
   ...
   * +kubebuilder:validation:Required
   *
   * @generated from field: optional github.com.akuity.kargo.api.v1alpha1.TargetPromotionSpec spec = 2;
   */
  spec?: TargetPromotionSpec;
...
/**
 * Describes the message github.com.akuity.kargo.api.v1alpha1.TargetPromotion.
 * Use `create(TargetPromotionSchema)` to create a new message.
 */
export const TargetPromotionSchema: GenMessage<TargetPromotion> = /*@__PURE__*/
  messageDesc(file_api_v1alpha1_generated, 95);

/**
 * TargetPromotionList contains a list of TargetPromotion resources.
 *
 * @generated from message github.com.akuity.kargo.api.v1alpha1.TargetPromotionList
 */
export type TargetPromotionList = Message<"github.com.akuity.kargo.api.v1alpha1.TargetPromotionList"> & {
  /**
   * @generated from field: optional k8s.io.apimachinery.pkg.apis.meta.v1.ListMeta metadata = 1;
   */
  metadata?: ListMeta;
  ...
  /**
   * @generated from field: repeated github.com.akuity.kargo.api.v1alpha1.TargetPromotion items = 2;
   */
  items: TargetPromotion[];
};

/**
 * Describes the message github.com.akuity.kargo.api.v1alpha1.TargetPromotionList.
 * Use `create(TargetPromotionListSchema)` to create a new message.
 */
export const TargetPromotionListSchema: GenMessage<TargetPromotionList> = /*@__PURE__*/
 ...
 *
 * @generated from message github.com.akuity.kargo.api.v1alpha1.TargetPromotionSpec
 */
export type TargetPromotionSpec = Message<"github.com.akuity.kargo.api.v1alpha1.TargetPromotionSpec"> & {
  /**
   ...
   * +kubebuilder:validation:items:XValidation:message="Promotion step must have uses set and must not reference a task",rule="has(self.uses) && !has(self.task)"
   *
   * @generated from field: repeated github.com.akuity.kargo.api.v1alpha1.PromotionStep steps = 5;
   */
  steps: PromotionStep[];
};

/**
 * Describes the message github.com.akuity.kargo.api.v1alpha1.TargetPromotionSpec.
 * Use `create(TargetPromotionSpecSchema)` to create a new message.
 */
export const TargetPromotionSpecSchema: GenMessage<TargetPromotionSpec> = /*@__PURE__*/
