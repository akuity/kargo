...
export type GitHubWebhookReceiverConfig = Message<"github.com.akuity.kargo.api.v1alpha1.GitHubWebhookReceiverConfig"> & {
   ...
   * +optional
   *
   * @generated from field: optional string baseURL = 2;
   */
  baseURL: string;
};
