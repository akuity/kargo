 ...
 *
 * @generated from message github.com.akuity.kargo.api.v1alpha1.GenericWarehouseRefreshConfig
 */
export type GenericWarehouseRefreshConfig = Message<"github.com.akuity.kargo.api.v1alpha1.GenericWarehouseRefreshConfig"> & {
  /**
   ...
   * +kubebuilder:validation:Required
   *
   * @generated from field: optional string repoURL = 2;
   */
  repoURL: string;
};

/**
 * Describes the message github.com.akuity.kargo.api.v1alpha1.GenericWarehouseRefreshConfig.
 * Use `create(GenericWarehouseRefreshConfigSchema)` to create a new message.
 */
export const GenericWarehouseRefreshConfigSchema: GenMessage<GenericWarehouseRefreshConfig> = /*@__PURE__*/
...
export type GenericWebhookReceiverConfig = Message<"github.com.akuity.kargo.api.v1alpha1.GenericWebhookReceiverConfig"> & {
   ...
   * +kubebuilder:validation:Required
   *
   * @generated from field: optional github.com.akuity.kargo.api.v1alpha1.GenericWarehouseRefreshConfig warehouseRefresh = 1;
   */
  warehouseRefresh?: GenericWarehouseRefreshConfig;
