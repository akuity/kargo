...
export const RuleEditor = ({
  ...
  const _Select = (props: SelectProps & { label: string }) => (
    <div>
      <div className='font-semibold text-xs text-gray-500 dark:text-neutral-400 mb-2 mt-2'>
        {props.label}
      </div>
  ...
  return (
    <div style={style} className='-mt-7'>
      <div className='mx-auto font-semibold mb-2 text-gray-500 dark:text-neutral-400 text-center text-sm'>
        NEW RULE
      </div>

      <div className='rounded-md p-3 border-2 border-gray-100 dark:border-neutral-700 border-solid'>
