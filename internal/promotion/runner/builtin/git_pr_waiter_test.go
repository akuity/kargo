...
func Test_gitPRWaiter_run(t *testing.T) {
	testCases := []struct {
		...
		assertions func(*testing.T, pkgPromotion.StepResult, error)
	}{
		{
			...
			assertions: func(t *testing.T, res pkgPromotion.StepResult, err error) {
