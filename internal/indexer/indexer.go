...
const (
	...
	ProjectsByWebhookReceiverPathsField = "receiverPaths"
)
...
// ProjectsByWebhookReceiverPaths is a client.IndexerFunc that indexes Projects by the
// paths of their receivers.
func ProjectsByWebhookReceiverPaths(obj client.Object) []string {
