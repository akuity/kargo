...
func TestAbortPromotionRequest_Equals(t *testing.T) {
	tests := []struct {
		name     string
		r1       *kargoapi.AbortPromotionRequest
		r2       *kargoapi.AbortPromotionRequest
		expected bool
	}{
		{
			name:     "both nil",
		...
		{
			name:     "one nil",
			r1:       &kargoapi.AbortPromotionRequest{Action: "fake-action", Actor: "fake-actor", ControlPlane: false},
			r2:       nil,
			expected: false,
		},
		{
			name:     "other nil",
			r1:       nil,
			r2:       &kargoapi.AbortPromotionRequest{Action: "fake-action", Actor: "fake-actor", ControlPlane: false},
			expected: false,
		},
		{
			name:     "different actions",
			r1:       &kargoapi.AbortPromotionRequest{Action: "fake-action", Actor: "fake-actor", ControlPlane: false},
			r2:       &kargoapi.AbortPromotionRequest{Action: "other-action", Actor: "fake-actor", ControlPlane: false},
			expected: false,
		},
		{
			name:     "different actors",
			r1:       &kargoapi.AbortPromotionRequest{Action: "fake-action", Actor: "fake-actor", ControlPlane: true},
			r2:       &kargoapi.AbortPromotionRequest{Action: "fake-action", Actor: "other-actor", ControlPlane: true},
			expected: false,
		},
		{
		...
		},
		{
			name:     "equal",
			r1:       &kargoapi.AbortPromotionRequest{Action: "fake-action", Actor: "fake-actor", ControlPlane: true},
			r2:       &kargoapi.AbortPromotionRequest{Action: "fake-action", Actor: "fake-actor", ControlPlane: true},
			expected: true,
		},
	}
