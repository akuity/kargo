...
```shell
curl -L https://raw.githubusercontent.com/akuity/kargo/refs/heads/release-1.6/hack/quickstart/install.sh | sh
```
...
```shell
curl -L https://raw.githubusercontent.com/akuity/kargo/refs/heads/release-1.6/hack/quickstart/kind.sh | sh
```
...
```shell
curl -L https://raw.githubusercontent.com/akuity/kargo/refs/heads/release-1.6/hack/quickstart/uninstall.sh | sh
```
