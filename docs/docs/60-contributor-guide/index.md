...
Pull requests that do not meet contribution policy requirements are
...
Kargo is maintained by Akuity, with priorities driven by Kargo Enterprise
customers. Maintainers review issues and pull requests that do not align with
those priorities purely on a best-effort basis.

- Do not ping maintainers for status updates.

- Do not open duplicate issues or PRs to draw attention.

- Do not leave "+1" or "any update?" comments on issues.

Persistent violations of these expectations may result in issues or PRs being
locked.
