...
```shell
curl -L https://raw.githubusercontent.com/akuity/kargo/release-0.7/hack/quickstart/install.sh | sh
```
...
```shell
curl -L https://raw.githubusercontent.com/akuity/kargo/release-0.7/hack/quickstart/kind.sh | sh
```
...
```shell
curl -L https://raw.githubusercontent.com/akuity/kargo/release-0.7/hack/quickstart/k3d.sh | sh
```
...
curl -L -o kargo https://github.com/akuity/kargo/releases/download/v0.7.1/kargo-"$(uname -s | tr '[:upper:]' '[:lower:]')-${arch}"
chmod +x kargo
```
...
```shell
Invoke-WebRequest -URI https://github.com/akuity/kargo/releases/download/v0.7.1/kargo-windows-amd64.exe -OutFile kargo.exe
```
...
```shell
curl -L https://raw.githubusercontent.com/akuity/kargo/release-0.7/hack/quickstart/uninstall.sh | sh
```
