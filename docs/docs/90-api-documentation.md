...
<a name="github-com-akuity-kargo-api-v1alpha1-DeepLink"></a>
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| title | [string](#string) |  Title is the display label for the link.   |
| url | [string](#string) |  URL is an expression that resolves to the link's href.   |
| description | [string](#string) |  Description is an optional human-readable summary shown alongside the link.  +optional |
| if | [string](#string) |  If is an optional expression condition. When set, the link is only shown when the expression evaluates to true.  +optional |
