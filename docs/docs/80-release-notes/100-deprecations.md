...
| The Connect-based API | [v1.9.0](./90-v1.9.0.md) | [v1.12.0](./88-v1.12.0.md#breaking-changes) | A new, RESTful API has been introduced. Most users will not be impacted beyond simply needing to upgrade their CLI when upgrading the back end to v1.9.0 or greater. |
