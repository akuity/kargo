...
<ReleaseNotesSchema version="v1.9.0" datePublished="2026-01-29" />

🚀 Our most significant release since v1.0.0. Although feature-packed, this
...
### 🕺🏻 The Secret Shuffle {#the-secret-shuffle}
...
* **"GitOps" users**: No immediate action required. Continue syncing to original
  ...
  removed in v1.12.0** -- update your manifests before then.

#### 🖥️ Better UI and CLI Support {#better-ui-and-cli-support}

The UI and CLI now have improved support for managing shared and system-level
resources, including `ConfigMap`s.

### 💤 The New REST API {#the-new-rest-api}
...
### 🪝 The Generic Webhook Receiver {#the-generic-webhook-receiver}
...
### 🪜 New and Improved Promotion Steps {#new-and-improved-promotion-steps}
