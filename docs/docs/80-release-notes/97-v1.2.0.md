...
For further information, please refer directly to the [Kargo Helm chart's README](https://github.com/akuity/kargo/blob/release-1.2/charts/kargo/README.md), which describes all configuration options in detail.
