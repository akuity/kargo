...
1. Download the CLI binary.
    ...
    curl -L -o kargo https://github.com/akuity/kargo/releases/download/v1.8.9/kargo-"$(uname -s | tr '[:upper:]' '[:lower:]')-${arch}"
    chmod +x kargo
    ```
    ...
    ```shell
    Invoke-WebRequest -URI https://github.com/akuity/kargo/releases/download/v1.8.9/kargo-windows-amd64.exe -OutFile kargo.exe
    ```
