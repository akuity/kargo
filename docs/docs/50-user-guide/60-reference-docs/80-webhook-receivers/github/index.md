...
subscribed to the Git repositories from which those events originated. When a
Warehouse has `includePaths` or `excludePaths` configured, the receiver extracts
