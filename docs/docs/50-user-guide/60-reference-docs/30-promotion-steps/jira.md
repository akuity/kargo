...
| `waitForStatus.pollInterval`   | `integer` | N        | Poll interval in seconds for checking issue status. Overrides the default controller reconciliation interval. Must be >= 1. Available in Kargo >= v1.10. |
