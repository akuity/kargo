...
type GitSubscription struct {
	...
	//   of tags eligible for selection. AllowTags and IgnoreTags are deprecated since v1.10.0 and will be removed in v1.13.0. From v.1.10.0, errors will be throw during artifact discovery if these fields are used. Please use AllowTagsRegex and IgnoreTagsRegex instead.
	//
	...
	//   narrow the set of tags eligible for selection. AllowTags and IgnoreTags are deprecated since v1.10.0 and will be removed in v1.13.0. From v.1.10.0, errors will be throw during artifact discovery if these fields are used. Please use AllowTagsRegex and IgnoreTagsRegex instead.
	//
	...
	// AllowTags is deprecated since v1.10.0 and will be removed in v1.13.0. From v.1.10.0, errors will be throw during artifact discovery if these fields are used. Please use AllowTagsRegex instead.
	//
	// +kubebuilder:validation:Optional
	AllowTags string `json:"allowTags,omitempty" protobuf:"bytes,5,opt,name=allowTags"`
	// +kubebuilder:validation:Optional
	// AllowTagsRegex is a list of regular expression that can optionally be used to limit the tags that are considered in determining the newest commit of interest.
	// The value in this field only has any effect when the CommitSelectionStrategy is Lexical, NewestTag, or SemVer. This field is optional.
	// +kubebuilder:validation:Optional
	...
	// optional.
	// IgnoreTags is deprecated since v1.10.0 in favour of IgnoreTagsRegex and will be removed in v1.13.0. From v.1.10.0, errors will be throw during artifact discovery if these fields are used.
	//
	// +kubebuilder:validation:Optional
	IgnoreTags []string `json:"ignoreTags,omitempty" protobuf:"bytes,6,rep,name=ignoreTags"`
	// IgnoreTagsRegex is a list of regular expression that can optionally be used to ignore the tags that are considered in determining the newest commit of interest.
	// The value in this field only has any effect when the CommitSelectionStrategy is Lexical, NewestTag, or SemVer. This field is optional.
	// +kubebuilder:validation:Optional
	...
	// AllowTags and IgnoreTags are deprecated since v1.10.0 and will be removed in v1.13.0. From v.1.10.0, errors will be throw during artifact discovery if these fields are used. Please use AllowTagsRegex and IgnoreTagsRegex instead.
	//
	...
	// commits based on the AllowTags and IgnoreTags fields. AllowTags and IgnoreTags are deprecated since v1.10.0 and will be removed in v1.13.0. From v.1.10.0, errors will be throw during artifact discovery if these fields are used. Please use AllowTagsRegex and IgnoreTagsRegex instead.
...
type ImageSubscription struct {
	...
	// +kubebuilder:validation:Optional
	AllowTags string `json:"allowTags,omitempty" protobuf:"bytes,5,opt,name=allowTags"`
	// AllowTagsRegex is a list of regular expression that can optionally be used to limit the image tags that are considered in determining the newest version of an image. This field is optional.
	//
	// +kubebuilder:validation:Optional
	AllowTagsRegex []string `json:"allowTagsRegex,omitempty" protobuf:"bytes,13,rep,name=allowTagsRegex"`
	// IgnoreTags is a list of tags that must be ignored when determining the
	...
	// IgnoreTags is deprecated since v1.10.0 and will be removed in v1.13.0. From v.1.10.0, errors will be throw during artifact discovery if these fields are used. Please use IgnoreTagsRegex instead.
	//
	// +kubebuilder:validation:Optional
	IgnoreTags []string `json:"ignoreTags,omitempty" protobuf:"bytes,6,rep,name=ignoreTags"`
	// IgnoreTagsRegex is a list of regular expression that can optionally be used to ignore the tags that are considered in determining the newest version of an image. This field is optional.
	//
	// +kubebuilder:validation:Optional
	IgnoreTagsRegex []string `json:"ignoreTagsRegex,omitempty" protobuf:"bytes,14,rep,name=ignoreTagsRegex"`
	...
	// filtering images based on the AllowTags and IgnoreTags fields. AllowTags and IgnoreTags are deprecated since v1.10.0 and will be removed in v1.13.0. From v.1.10.0, errors will be throw during artifact discovery if these fields are used. Please use AllowTagsRegex and IgnoreTagsRegex instead.
