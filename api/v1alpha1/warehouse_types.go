...
// +kubebuilder:validation:XValidation:message="a constraint or semverConstraint must be specified when imageSelectionStrategy is Digest",rule="!(self.imageSelectionStrategy == 'Digest') || has(self.constraint) || has(self.semverConstraint)"
