...
var fileDescriptor_e26b7f7bbc391025 = []byte{
	...
	0x4d, 0x65, 0xa7, 0x8f, 0x90, 0xcd, 0x1a, 0x91, 0x6c, 0x9a, 0x64, 0xd3, 0xfc, 0x00, 0xce, 0x24,
	0x67, 0x1d, 0xf6, 0x17, 0xc9, 0x6f, 0x13, 0xcf, 0x7f, 0xbe, 0x16, 0xd4, 0x58, 0x27, 0x5e, 0x03,
	0x0b, 0x0a, 0x7a, 0x12, 0xb2, 0x1d, 0xb7, 0x19, 0x7f, 0xd3, 0x79, 0x0b, 0xaf, 0x61, 0x5e, 0x5e,
	0x7a, 0xf3, 0xd3, 0x2f, 0xcf, 0x9d, 0xfa, 0xec, 0xcb, 0x73, 0xa7, 0xbe, 0xf8, 0xf2, 0xdc, 0xa9,
	0x0f, 0xf7, 0xcf, 0x19, 0x9f, 0xee, 0x9f, 0x33, 0x3e, 0xdb, 0x3f, 0x67, 0x7c, 0xb1, 0x7f, 0xce,
	0xf8, 0xf7, 0xfd, 0x73, 0xc6, 0x47, 0xbf, 0x38, 0x77, 0xea, 0xee, 0xd3, 0xfd, 0x7c, 0x8c, 0xfb,
	0x7f, 0x02, 0x00, 0x00, 0xff, 0xff, 0xa9, 0x83, 0xd9, 0x24, 0xb3, 0x5b, 0x00, 0x00,
}
...
func (this *WebhookReceiverConfig) String() string {
	...
	s := strings.Join([]string{`&WebhookReceiverConfig{`,
		...
		`GitLab:` + strings.Replace(this.GitLab.String(), "GitHubWebhookReceiverConfig", "GitHubWebhookReceiverConfig", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *WebhookReceiverConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.GitLab == nil {
				m.GitLab = &GitHubWebhookReceiverConfig{}
			}
