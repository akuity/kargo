...
type FreightOrigin struct {
	...
	//
	// +kubebuilder:validation:Required
	Kind FreightOriginKind `json:"kind"`
...
type FreightSources struct {
	...
	AvailabilityStrategy FreightAvailabilityStrategy `json:"availabilityStrategy,omitempty"`
...
type StageStatus struct {
	...
	FreightHistory FreightHistory `json:"freightHistory,omitempty"`
...
type FreightCollection struct {
	...
	// origin.
	Freight map[string]FreightReference `json:"items,omitempty"`
	// VerificationHistory is a stack of recent VerificationInfo. By default,
	// the last ten VerificationInfo are stored.
	VerificationHistory VerificationInfoStack `json:"verificationHistory,omitempty"`
}
