...
type Stage struct {
	...
	Spec	*StageSpec	`json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
...
type StageSpec struct {
	...
	//
	//+kubebuilder:validation:Required
	Subscriptions	*Subscriptions	`json:"subscriptions,omitempty" protobuf:"bytes,1,opt,name=subscriptions"`
...
type GitRepoUpdate struct {
	...
	//+kubebuilder:validation:MinLength=1
	//+kubebuilder:validation:Pattern=`^\w+([-/]\w+)*$`
	WriteBranch	string	`json:"writeBranch,omitempty" protobuf:"bytes,4,opt,name=writeBranch"`
...
type KargoRenderImageUpdate struct {
	...
	//
	//+kubebuilder:validation:Optional
	UseDigest	bool	`json:"useDigest,omitempty" protobuf:"varint,2,opt,name=useDigest"`
}
...
type KustomizePromotionMechanism struct {
	...
	Images []KustomizeImageUpdate `json:"images,omitempty" protobuf:"bytes,1,rep,name=images"`
}
...
type KustomizeImageUpdate struct {
	...
	//
	//+kubebuilder:validation:Optional
	UseDigest	bool	`json:"useDigest,omitempty" protobuf:"varint,3,opt,name=useDigest"`
}
...
type HelmImageUpdate struct {
	...
	//+kubebuilder:validation:MinLength=1
	//+kubebuilder:validation:Pattern=^[\w-\.]+(/[\w-\.]+)*$
	ValuesFilePath	string	`json:"valuesFilePath,omitempty" protobuf:"bytes,2,opt,name=valuesFilePath"`
	...
	Value	ImageUpdateValueType	`json:"value,omitempty" protobuf:"bytes,4,opt,name=value"`
}
...
type HelmChartDependencyUpdate struct {
	...
	//+kubebuilder:validation:MinLength=1
	//+kubebuilder:validation:Pattern=^[\w-\.]+(/[\w-\.]+)*$
	ChartPath	string	`json:"chartPath,omitempty" protobuf:"bytes,3,opt,name=chartPath"`
}
...
type ArgoCDAppUpdate struct {
	...
	//+kubebuilder:validation:MinLength=1
	//+kubebuilder:validation:Pattern=^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*$
	AppName	string	`json:"appName,omitempty" protobuf:"bytes,1,opt,name=appName"`
...
type ArgoCDKustomize struct {
	...
	//
	//+kubebuilder:validation:MinItems=1
	Images []ArgoCDKustomizeImageUpdate `json:"images,omitempty" protobuf:"bytes,1,rep,name=images"`
}
...
type ArgoCDHelm struct {
	...
	//
	//+kubebuilder:validation:MinItems=1
	Images []ArgoCDHelmImageUpdate `json:"images,omitempty" protobuf:"bytes,1,rep,name=images"`
}
...
type ArgoCDHelmImageUpdate struct {
	...
	//
	// This is a required field.
	Value	ImageUpdateValueType	`json:"value,omitempty" protobuf:"bytes,3,opt,name=value"`
}
...
type ArgoCDAppHealthStatus struct {
	Status	ArgoCDAppHealthState	`json:"status,omitempty" protobuf:"bytes,1,opt,name=status"`
	Message	string			`json:"message,omitempty" protobuf:"bytes,2,opt,name=message"`
}

// ArgoCDAppSyncStatus describes the sync status of an ArgoCD Application.
type ArgoCDAppSyncStatus struct {
	Status		ArgoCDAppSyncState	`json:"status,omitempty" protobuf:"bytes,1,opt,name=status"`
...
type StageList struct {
	...
	Items		[]Stage	`json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
