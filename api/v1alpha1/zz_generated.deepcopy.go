...
func (in *GenericWebhookAction) DeepCopyInto(out *GenericWebhookAction) {
	*out = *in
	if in.MatchConditions != nil {
		...
		*out = make([]ConditionSelector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Targets != nil {
		...
		*out = make([]GenericWebhookTarget, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenericWebhookTarget) DeepCopyInto(out *GenericWebhookTarget) {
	*out = *in
	in.LabelSelector.DeepCopyInto(&out.LabelSelector)
	in.IndexSelector.DeepCopyInto(&out.IndexSelector)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericWebhookTarget.
func (in *GenericWebhookTarget) DeepCopy() *GenericWebhookTarget {
	if in == nil {
		return nil
	}
	out := new(GenericWebhookTarget)
	in.DeepCopyInto(out)
	return out
}
