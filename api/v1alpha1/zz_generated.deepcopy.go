...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CopyPatchOperation) DeepCopyInto(out *CopyPatchOperation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CopyPatchOperation.
func (in *CopyPatchOperation) DeepCopy() *CopyPatchOperation {
	if in == nil {
		return nil
	}
	out := new(CopyPatchOperation)
	in.DeepCopyInto(out)
	return out
}
