...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *YttConfig) DeepCopyInto(out *YttConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new YttConfig.
func (in *YttConfig) DeepCopy() *YttConfig {
	if in == nil {
		return nil
	}
	out := new(YttConfig)
