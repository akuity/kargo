...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenericArtifactPushConfig) DeepCopyInto(out *GenericArtifactPushConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericWarehouseRefreshConfig.
func (in *GenericArtifactPushConfig) DeepCopy() *GenericArtifactPushConfig {
	if in == nil {
		return nil
	}
	out := new(GenericArtifactPushConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GenericWebhookReceiverConfig) DeepCopyInto(out *GenericWebhookReceiverConfig) {
	*out = *in
	if in.ArtifactPush != nil {
		in, out := &in.ArtifactPush, &out.ArtifactPush
		*out = new(GenericArtifactPushConfig)
		**out = **in
	}
	out.SecretRef = in.SecretRef
