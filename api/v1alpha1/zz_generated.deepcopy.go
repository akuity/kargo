...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StageState) DeepCopyInto(out *StageState) {
	*out = *in
	if in.FirstSeen != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StageState.
func (in *StageState) DeepCopy() *StageState {
	if in == nil {
		return nil
	}
	out := new(StageState)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in StageStateStack) DeepCopyInto(out *StageStateStack) {
	{
		in := &in
		*out = make(StageStateStack, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StageStateStack.
func (in StageStateStack) DeepCopy() StageStateStack {
	if in == nil {
		return nil
	}
	out := new(StageStateStack)
	in.DeepCopyInto(out)
	return *out
}
