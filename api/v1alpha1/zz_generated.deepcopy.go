...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LastPromotionInfo) DeepCopyInto(out *LastPromotionInfo) {
	*out = *in
	in.Freight.DeepCopyInto(&out.Freight)
	in.Status.DeepCopyInto(&out.Status)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LastPromotionInfo.
func (in *LastPromotionInfo) DeepCopy() *LastPromotionInfo {
	if in == nil {
		return nil
	}
	out := new(LastPromotionInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WarehouseStatus) DeepCopyInto(out *WarehouseStatus) {
	*out = *in
	if in.LastFreight != nil {
		in, out := &in.LastFreight, &out.LastFreight
		*out = new(FreightReference)
		(*in).DeepCopyInto(*out)
	}
}
