...
func (in *AbortPromotionRequest) DeepCopyInto(out *AbortPromotionRequest) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AbortPromotionRequest.
func (in *AbortPromotionRequest) DeepCopy() *AbortPromotionRequest {
	if in == nil {
		return nil
	}
	out := new(AbortPromotionRequest)
	in.DeepCopyInto(out)
	return out
}
