...
func (in *PromotionSpec) DeepCopyInto(out *PromotionSpec) {
	*out = *in
	if in.Vars != nil {
		...
		*out = make([]PromotionVariable, len(*in))
		copy(*out, *in)
	}
	if in.Steps != nil {
...
func (in *PromotionStep) DeepCopyInto(out *PromotionStep) {
	*out = *in
	...
	if in.Inputs != nil {
		...
		*out = make([]PromotionStepInput, len(*in))
		copy(*out, *in)
	}
	if in.Config != nil {
		in, out := &in.Config, &out.Config
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PromotionStepInput) DeepCopyInto(out *PromotionStepInput) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PromotionStepInput.
func (in *PromotionStepInput) DeepCopy() *PromotionStepInput {
	if in == nil {
		return nil
	}
	out := new(PromotionStepInput)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PromotionTaskInput) DeepCopyInto(out *PromotionTaskInput) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PromotionTaskInput.
func (in *PromotionTaskInput) DeepCopy() *PromotionTaskInput {
	if in == nil {
		return nil
	}
	out := new(PromotionTaskInput)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PromotionTaskSpec) DeepCopyInto(out *PromotionTaskSpec) {
	*out = *in
	if in.Inputs != nil {
		in, out := &in.Inputs, &out.Inputs
		*out = make([]PromotionTaskInput, len(*in))
		copy(*out, *in)
	}
	if in.Steps != nil {
		in, out := &in.Steps, &out.Steps
