...
package kargov1alpha1connect

import (
	context "context"
	errors "errors"
	v1alpha1 "github.com/akuity/kargo/pkg/api/gen/kargo/v1alpha1"
...
const (
	...
	KargoServiceName = "akuity.io.kargo.v1alpha1.KargoService"
)
...
const (
	...
	KargoServiceListEnvironmentsProcedure = "/akuity.io.kargo.v1alpha1.KargoService/ListEnvironments"
	// KargoServiceGetEnvironmentProcedure is the fully-qualified name of the KargoService's
	// GetEnvironment RPC.
	KargoServiceGetEnvironmentProcedure = "/akuity.io.kargo.v1alpha1.KargoService/GetEnvironment"
)

// KargoServiceClient is a client for the akuity.io.kargo.v1alpha1.KargoService service.
...
// NewKargoServiceClient constructs a client for the akuity.io.kargo.v1alpha1.KargoService service.
...
// ListEnvironments calls akuity.io.kargo.v1alpha1.KargoService.ListEnvironments.
...
// GetEnvironment calls akuity.io.kargo.v1alpha1.KargoService.GetEnvironment.
...
// KargoServiceHandler is an implementation of the akuity.io.kargo.v1alpha1.KargoService service.
...
func NewKargoServiceHandler(svc KargoServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/akuity.io.kargo.v1alpha1.KargoService/", mux
}
...
func (UnimplementedKargoServiceHandler) ListEnvironments(context.Context, *connect_go.Request[v1alpha1.ListEnvironmentsRequest]) (*connect_go.Response[v1alpha1.ListEnvironmentsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("akuity.io.kargo.v1alpha1.KargoService.ListEnvironments is not implemented"))
}
...
func (UnimplementedKargoServiceHandler) GetEnvironment(context.Context, *connect_go.Request[v1alpha1.GetEnvironmentRequest]) (*connect_go.Response[v1alpha1.GetEnvironmentResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("akuity.io.kargo.v1alpha1.KargoService.GetEnvironment is not implemented"))
}
