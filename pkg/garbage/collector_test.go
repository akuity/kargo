...
func TestNewCollector(t *testing.T) {
	...
	require.NotNil(t, c.cleanProjectPromotionRequestsFn)
	require.NotNil(t, c.cleanStagePromotionRequestsFn)
	require.NotNil(t, c.listPromotionRequestsFn)
	require.NotNil(t, c.deletePromotionRequestFn)
