...
func Test_server_updateProjectConfigMap(t *testing.T) {
	...
	testRESTEndpoint(
		...
		http.MethodPut, "/v2/projects/"+testProject.Name+"/configmaps/"+testConfigMap.Name,
		[]restTestCase{
			{
...
func Test_server_updateSystemConfigMap(t *testing.T) {
	...
	testRESTEndpoint(
		...
		http.MethodPut, "/v2/system/configmaps/"+testConfigMap.Name,
		[]restTestCase{
			{
				name: "invalid JSON in request body",
				body: bytes.NewBufferString("{invalid json"),
...
func Test_server_updateSharedConfigMap(t *testing.T) {
	...
	testRESTEndpoint(
		...
		http.MethodPut, "/v2/shared/configmaps/"+testConfigMap.Name,
		[]restTestCase{
			{
				name: "invalid JSON in request body",
				body: bytes.NewBufferString("{invalid json"),
