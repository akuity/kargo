...
type PullRequest struct {
	...
	// indicates the provider does not expose mergeability information.
	Mergeable *bool `json:"mergeable,omitempty"`
	// Draft indicates whether the PR is a draft. Defaults to false.
