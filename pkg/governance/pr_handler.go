...
// per-repository dependencies (config, owner/repo, clients) and their
// associated methods are accessible directly on the handler.
...
func (h *prHandler) handleOpened(
	...
	if err := h.applyPRPolicy(ctx, pr, login); err != nil {
