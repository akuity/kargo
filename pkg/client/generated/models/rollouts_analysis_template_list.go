...
func (m *RolloutsAnalysisTemplateList) validateItems(formats strfmt.Registry) error {
...
func (m *RolloutsAnalysisTemplateList) validateMetadata(formats strfmt.Registry) error {
...
func (m *RolloutsAnalysisTemplateList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RolloutsAnalysisTemplateList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RolloutsAnalysisTemplateList) UnmarshalBinary(b []byte) error {
	var res RolloutsAnalysisTemplateList
