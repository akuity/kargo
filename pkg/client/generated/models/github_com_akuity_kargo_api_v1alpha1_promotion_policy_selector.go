...
// GithubComAkuityKargoAPIV1alpha1PromotionPolicySelector github com akuity kargo api v1alpha1 promotion policy selector
//
// swagger:model github_com_akuity_kargo_api_v1alpha1.PromotionPolicySelector
type GithubComAkuityKargoAPIV1alpha1PromotionPolicySelector struct {
...
// Validate validates this github com akuity kargo api v1alpha1 promotion policy selector
func (m *GithubComAkuityKargoAPIV1alpha1PromotionPolicySelector) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GithubComAkuityKargoAPIV1alpha1PromotionPolicySelector) validateMatchExpressions(formats strfmt.Registry) error {
...
// ContextValidate validate this github com akuity kargo api v1alpha1 promotion policy selector based on the context it is used
func (m *GithubComAkuityKargoAPIV1alpha1PromotionPolicySelector) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GithubComAkuityKargoAPIV1alpha1PromotionPolicySelector) contextValidateMatchExpressions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GithubComAkuityKargoAPIV1alpha1PromotionPolicySelector) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GithubComAkuityKargoAPIV1alpha1PromotionPolicySelector) UnmarshalBinary(b []byte) error {
	var res GithubComAkuityKargoAPIV1alpha1PromotionPolicySelector
