...
func (a *Client) ListProjectEvents(params *ListProjectEventsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListProjectEventsOK, error) {
	...
	if params == nil {
		params = NewListProjectEventsParams()
	}
	op := &runtime.ClientOperation{
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListProjectEventsReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ListProjectEventsOK)
	if ok {
		return success, nil
	}
	...
	msg := fmt.Sprintf("unexpected success response for ListProjectEvents: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
