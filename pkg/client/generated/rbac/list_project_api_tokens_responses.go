...
func (o *ListProjectAPITokensReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1beta1/projects/{project}/apitokens] ListProjectAPITokens", response, response.Code())
	}
}
...
func (o *ListProjectAPITokensOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1beta1/projects/{project}/apitokens][%d] listProjectApiTokensOK %s", 200, payload)
}
