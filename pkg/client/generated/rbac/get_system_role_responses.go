...
func (o *GetSystemRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v2/system/roles/{role}] GetSystemRole", response, response.Code())
	}
}
...
func (o *GetSystemRoleOK) Error() string {
	...
	return fmt.Sprintf("[GET /v2/system/roles/{role}][%d] getSystemRoleOK %s", 200, payload)
}
