...
func (o *CreateSystemAPITokenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1beta1/system/roles/{role}/apitokens] CreateSystemAPIToken", response, response.Code())
	}
}
...
func (o *CreateSystemAPITokenCreated) Error() string {
	...
	return fmt.Sprintf("[POST /v1beta1/system/roles/{role}/apitokens][%d] createSystemApiTokenCreated %s", 201, payload)
}
