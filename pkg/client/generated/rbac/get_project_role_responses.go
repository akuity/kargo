...
func (o *GetProjectRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v2/projects/{project}/roles/{role}] GetProjectRole", response, response.Code())
	}
}
...
func (o *GetProjectRoleOK) Error() string {
	...
	return fmt.Sprintf("[GET /v2/projects/{project}/roles/{role}][%d] getProjectRoleOK %s", 200, payload)
}
