...
func (o *DeleteProjectAPITokenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 204:
		result := NewDeleteProjectAPITokenNoContent()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1beta1/projects/{project}/api-tokens/{apitoken}] DeleteProjectAPIToken", response, response.Code())
	}
}
...
func NewDeleteProjectAPITokenNoContent() *DeleteProjectAPITokenNoContent {
	return &DeleteProjectAPITokenNoContent{}
}
...
func (o *DeleteProjectAPITokenNoContent) Code() int {
	return 204
}

func (o *DeleteProjectAPITokenNoContent) Error() string {
	return fmt.Sprintf("[DELETE /v1beta1/projects/{project}/api-tokens/{apitoken}][%d] deleteProjectApiTokenNoContent", 204)
}
