...
func (o *CreateProjectAPITokenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v2/projects/{project}/roles/{role}/apitokens] CreateProjectAPIToken", response, response.Code())
	}
}
...
func (o *CreateProjectAPITokenCreated) Error() string {
	...
	return fmt.Sprintf("[POST /v2/projects/{project}/roles/{role}/apitokens][%d] createProjectApiTokenCreated %s", 201, payload)
}
