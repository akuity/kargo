...
func (o *GetSystemAPITokenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v2/system/apitokens/{apitoken}] GetSystemAPIToken", response, response.Code())
	}
}
...
func (o *GetSystemAPITokenOK) Error() string {
	...
	return fmt.Sprintf("[GET /v2/system/apitokens/{apitoken}][%d] getSystemApiTokenOK %s", 200, payload)
}
