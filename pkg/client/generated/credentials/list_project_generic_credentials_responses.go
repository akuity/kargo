...
func (o *ListProjectGenericCredentialsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		result := NewListProjectGenericCredentialsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1beta1/projects/{project}/generic-credentials] ListProjectGenericCredentials", response, response.Code())
	}
}
...
func NewListProjectGenericCredentialsOK() *ListProjectGenericCredentialsOK {
	return &ListProjectGenericCredentialsOK{}
}
...
func (o *ListProjectGenericCredentialsOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1beta1/projects/{project}/generic-credentials][%d] listProjectGenericCredentialsOK %s", 200, payload)
}
...
func (o *ListProjectGenericCredentialsOK) GetPayload() *models.V1SecretList {
	return o.Payload
}

func (o *ListProjectGenericCredentialsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
