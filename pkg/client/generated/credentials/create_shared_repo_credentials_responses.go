...
func (o *CreateSharedRepoCredentialsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v2/shared/repo-credentials] CreateSharedRepoCredentials", response, response.Code())
	}
}
...
func (o *CreateSharedRepoCredentialsCreated) Error() string {
	...
	return fmt.Sprintf("[POST /v2/shared/repo-credentials][%d] createSharedRepoCredentialsCreated %s", 201, payload)
}
