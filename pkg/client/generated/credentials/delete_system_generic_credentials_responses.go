...
func (o *DeleteSystemGenericCredentialsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 204:
		result := NewDeleteSystemGenericCredentialsNoContent()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1beta1/system/generic-credentials/{generic-credentials}] DeleteSystemGenericCredentials", response, response.Code())
	}
}
...
func NewDeleteSystemGenericCredentialsNoContent() *DeleteSystemGenericCredentialsNoContent {
	return &DeleteSystemGenericCredentialsNoContent{}
}
...
func (o *DeleteSystemGenericCredentialsNoContent) Error() string {
	return fmt.Sprintf("[DELETE /v1beta1/system/generic-credentials/{generic-credentials}][%d] deleteSystemGenericCredentialsNoContent", 204)
}
...
func (o *DeleteSystemGenericCredentialsNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
