...
func (o *DeleteSystemGenericCredentialsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v2/system/generic-credentials/{generic-credentials}] DeleteSystemGenericCredentials", response, response.Code())
	}
}
...
func (o *DeleteSystemGenericCredentialsNoContent) Error() string {
	return fmt.Sprintf("[DELETE /v2/system/generic-credentials/{generic-credentials}][%d] deleteSystemGenericCredentialsNoContent", 204)
}
