...
func (o *GetProjectRepoCredentialsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v2/projects/{project}/repo-credentials/{repo-credentials}] GetProjectRepoCredentials", response, response.Code())
	}
}
...
func (o *GetProjectRepoCredentialsOK) Error() string {
	...
	return fmt.Sprintf("[GET /v2/projects/{project}/repo-credentials/{repo-credentials}][%d] getProjectRepoCredentialsOK %s", 200, payload)
}
