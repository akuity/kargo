...
func (o *GetProjectGenericCredentialsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		result := NewGetProjectGenericCredentialsOK()
...
func NewGetProjectGenericCredentialsOK() *GetProjectGenericCredentialsOK {
	return &GetProjectGenericCredentialsOK{}
}
...
func (o *GetProjectGenericCredentialsOK) GetPayload() *models.V1Secret {
	return o.Payload
}

func (o *GetProjectGenericCredentialsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
