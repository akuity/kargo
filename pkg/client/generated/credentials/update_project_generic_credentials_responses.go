...
func (o *UpdateProjectGenericCredentialsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		result := NewUpdateProjectGenericCredentialsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /v1beta1/projects/{project}/generic-credentials/{generic-credentials}] UpdateProjectGenericCredentials", response, response.Code())
	}
}
...
func NewUpdateProjectGenericCredentialsOK() *UpdateProjectGenericCredentialsOK {
	return &UpdateProjectGenericCredentialsOK{}
}
...
func (o *UpdateProjectGenericCredentialsOK) Error() string {
	...
	return fmt.Sprintf("[PUT /v1beta1/projects/{project}/generic-credentials/{generic-credentials}][%d] updateProjectGenericCredentialsOK %s", 200, payload)
}
...
func (o *UpdateProjectGenericCredentialsOK) GetPayload() *models.V1Secret {
	return o.Payload
}

func (o *UpdateProjectGenericCredentialsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
