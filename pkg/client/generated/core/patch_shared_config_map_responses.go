...
func (o *PatchSharedConfigMapReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v2/shared/configmaps/{configmap}] PatchSharedConfigMap", response, response.Code())
	}
}
...
func (o *PatchSharedConfigMapOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /v2/shared/configmaps/{configmap}][%d] patchSharedConfigMapOK %s", 200, payload)
}
