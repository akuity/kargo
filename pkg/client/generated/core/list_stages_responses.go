...
StageList custom resource
*/
type ListStagesOK struct {
	Payload *models.GithubComAkuityKargoAPIV1alpha1StageList
}
...
func (o *ListStagesOK) GetPayload() *models.GithubComAkuityKargoAPIV1alpha1StageList {
	return o.Payload
}

func (o *ListStagesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GithubComAkuityKargoAPIV1alpha1StageList)
