...
func (o *DeleteSystemConfigMapReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v2/system/configmaps/{configmap}] DeleteSystemConfigMap", response, response.Code())
	}
}
...
func (o *DeleteSystemConfigMapNoContent) Error() string {
	return fmt.Sprintf("[DELETE /v2/system/configmaps/{configmap}][%d] deleteSystemConfigMapNoContent", 204)
}
