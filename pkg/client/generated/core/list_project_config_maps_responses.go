...
func (o *ListProjectConfigMapsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		result := NewListProjectConfigMapsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1beta1/projects/{project}/configmaps] ListProjectConfigMaps", response, response.Code())
	}
}
...
func NewListProjectConfigMapsOK() *ListProjectConfigMapsOK {
	return &ListProjectConfigMapsOK{}
}
...
func (o *ListProjectConfigMapsOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1beta1/projects/{project}/configmaps][%d] listProjectConfigMapsOK %s", 200, payload)
}
...
func (o *ListProjectConfigMapsOK) GetPayload() *models.V1ConfigMapList {
	return o.Payload
}

func (o *ListProjectConfigMapsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
