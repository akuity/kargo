...
//
//    argoCDUpdateConfig, err := UnmarshalArgoCDUpdateConfig(bytes)
//    bytes, err = argoCDUpdateConfig.Marshal()
//
//    commonDefs, err := UnmarshalCommonDefs(bytes)
//    bytes, err = commonDefs.Marshal()
//
//    composeOutput, err := UnmarshalComposeOutput(bytes)
//    bytes, err = composeOutput.Marshal()
//
//    copyConfig, err := UnmarshalCopyConfig(bytes)
//    bytes, err = copyConfig.Marshal()
//
//    deleteConfig, err := UnmarshalDeleteConfig(bytes)
//    bytes, err = deleteConfig.Marshal()
//
//    gitClearConfig, err := UnmarshalGitClearConfig(bytes)
//    bytes, err = gitClearConfig.Marshal()
//
//    gitCloneConfig, err := UnmarshalGitCloneConfig(bytes)
//    bytes, err = gitCloneConfig.Marshal()
//
//    gitCommitConfig, err := UnmarshalGitCommitConfig(bytes)
//    bytes, err = gitCommitConfig.Marshal()
//
//    gitOpenPRConfig, err := UnmarshalGitOpenPRConfig(bytes)
//    bytes, err = gitOpenPRConfig.Marshal()
//
//    gitPushConfig, err := UnmarshalGitPushConfig(bytes)
//    bytes, err = gitPushConfig.Marshal()
//
//    gitWaitForPRConfig, err := UnmarshalGitWaitForPRConfig(bytes)
//    bytes, err = gitWaitForPRConfig.Marshal()
//
//    helmTemplateConfig, err := UnmarshalHelmTemplateConfig(bytes)
//    bytes, err = helmTemplateConfig.Marshal()
//
//    helmUpdateChartConfig, err := UnmarshalHelmUpdateChartConfig(bytes)
//    bytes, err = helmUpdateChartConfig.Marshal()
//
//    hTTPConfig, err := UnmarshalHTTPConfig(bytes)
//    bytes, err = hTTPConfig.Marshal()
//
//    jSONParseConfig, err := UnmarshalJSONParseConfig(bytes)
//    bytes, err = jSONParseConfig.Marshal()
//
//    jSONUpdateConfig, err := UnmarshalJSONUpdateConfig(bytes)
//    bytes, err = jSONUpdateConfig.Marshal()
//
//    kustomizeBuildConfig, err := UnmarshalKustomizeBuildConfig(bytes)
//    bytes, err = kustomizeBuildConfig.Marshal()
//
//    kustomizeSetImageConfig, err := UnmarshalKustomizeSetImageConfig(bytes)
//    bytes, err = kustomizeSetImageConfig.Marshal()
//
//    yAMLParseConfig, err := UnmarshalYAMLParseConfig(bytes)
//    bytes, err = yAMLParseConfig.Marshal()
//
//    yAMLUpdateConfig, err := UnmarshalYAMLUpdateConfig(bytes)
//    bytes, err = yAMLUpdateConfig.Marshal()

package main

import "encoding/json"

func UnmarshalArgoCDUpdateConfig(data []byte) (ArgoCDUpdateConfig, error) {
	var r ArgoCDUpdateConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *ArgoCDUpdateConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type CommonDefs interface{}

func UnmarshalCommonDefs(data []byte) (CommonDefs, error) {
	var r CommonDefs
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *CommonDefs) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type ComposeOutput map[string]interface{}

func UnmarshalComposeOutput(data []byte) (ComposeOutput, error) {
	var r ComposeOutput
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *ComposeOutput) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalCopyConfig(data []byte) (CopyConfig, error) {
	var r CopyConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *CopyConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalDeleteConfig(data []byte) (DeleteConfig, error) {
	var r DeleteConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *DeleteConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalGitClearConfig(data []byte) (GitClearConfig, error) {
	var r GitClearConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *GitClearConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalGitCloneConfig(data []byte) (GitCloneConfig, error) {
	var r GitCloneConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *GitCloneConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalGitCommitConfig(data []byte) (GitCommitConfig, error) {
	var r GitCommitConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *GitCommitConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalGitOpenPRConfig(data []byte) (GitOpenPRConfig, error) {
	var r GitOpenPRConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *GitOpenPRConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalGitPushConfig(data []byte) (GitPushConfig, error) {
	var r GitPushConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *GitPushConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalGitWaitForPRConfig(data []byte) (GitWaitForPRConfig, error) {
	var r GitWaitForPRConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *GitWaitForPRConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalHelmTemplateConfig(data []byte) (HelmTemplateConfig, error) {
	var r HelmTemplateConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *HelmTemplateConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalHelmUpdateChartConfig(data []byte) (HelmUpdateChartConfig, error) {
	var r HelmUpdateChartConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *HelmUpdateChartConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalHTTPConfig(data []byte) (HTTPConfig, error) {
	var r HTTPConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *HTTPConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalJSONParseConfig(data []byte) (JSONParseConfig, error) {
	var r JSONParseConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *JSONParseConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalJSONUpdateConfig(data []byte) (JSONUpdateConfig, error) {
	var r JSONUpdateConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *JSONUpdateConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalKustomizeBuildConfig(data []byte) (KustomizeBuildConfig, error) {
	var r KustomizeBuildConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *KustomizeBuildConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalKustomizeSetImageConfig(data []byte) (KustomizeSetImageConfig, error) {
	var r KustomizeSetImageConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *KustomizeSetImageConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalYAMLParseConfig(data []byte) (YAMLParseConfig, error) {
	var r YAMLParseConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *YAMLParseConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalYAMLUpdateConfig(data []byte) (YAMLUpdateConfig, error) {
	var r YAMLUpdateConfig
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *YAMLUpdateConfig) Marshal() ([]byte, error) {
	return json.Marshal(r)
}
