...
type V1ManagedFieldsEntry struct {
	...
	// Operation is the type of operation which lead to this ManagedFieldsEntry being created. The only valid values for this field are 'Apply' and 'Update'. +k8s:alpha(since: \"1.37\")=+k8s:required
