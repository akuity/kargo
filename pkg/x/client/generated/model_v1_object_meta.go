...
type V1ObjectMeta struct {
	...
	// Number of seconds allowed for this object to gracefully terminate before it will be removed from the system. Only set when deletionTimestamp is also set. May only be shortened. Read-only. +optional +k8s:alpha(since: \"1.37\")=+k8s:optional +k8s:alpha(since: \"1.37\")=+k8s:immutable
	...
	// A sequence number representing a specific generation of the desired state. Populated by the system. Read-only. +optional +k8s:alpha(since: \"1.37\")=+k8s:optional +k8s:alpha(since: \"1.37\")=+k8s:minimum=0
