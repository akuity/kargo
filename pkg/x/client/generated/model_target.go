...
func (o *Target) GetApiVersion() string {
...
func (o *Target) GetApiVersionOk() (*string, bool) {
	if o == nil || IsNil(o.ApiVersion) {
		return nil, false
	}
...
func (o *Target) HasApiVersion() bool {
	if o != nil && !IsNil(o.ApiVersion) {
		return true
	}
...
func (o *Target) SetApiVersion(v string) {
	o.ApiVersion = &v
}
...
func (o *Target) GetMetadata() V1ObjectMeta {
...
// and a boolean to check if the value has been set.
func (o *Target) GetMetadataOk() (*V1ObjectMeta, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
func (o *Target) SetMetadata(v V1ObjectMeta) {
	o.Metadata = &v
}
...
// and a boolean to check if the value has been set.
func (o *Target) GetSpecOk() (*TargetSpec, bool) {
	if o == nil || IsNil(o.Spec) {
		return nil, false
	}
	return o.Spec, true
...
// SetSpec gets a reference to the given TargetSpec and assigns it to the Spec field.
func (o *Target) SetSpec(v TargetSpec) {
	o.Spec = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *Target) GetStatus() TargetStatus {
...
// and a boolean to check if the value has been set.
func (o *Target) GetStatusOk() (*TargetStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
// SetStatus gets a reference to the given TargetStatus and assigns it to the Status field.
func (o *Target) SetStatus(v TargetStatus) {
	o.Status = &v
}
