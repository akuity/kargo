...
// and a boolean to check if the value has been set.
func (o *Target) GetStatusOk() (any, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
// SetStatus gets a reference to the given any and assigns it to the Status field.
func (o *Target) SetStatus(v any) {
	o.Status = v
}
