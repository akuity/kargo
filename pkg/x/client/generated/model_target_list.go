...
func (o *TargetList) GetApiVersion() string {
...
func (o *TargetList) GetApiVersionOk() (*string, bool) {
	if o == nil || IsNil(o.ApiVersion) {
		return nil, false
	}
...
func (o *TargetList) HasApiVersion() bool {
	if o != nil && !IsNil(o.ApiVersion) {
		return true
	}
...
func (o *TargetList) SetApiVersion(v string) {
	o.ApiVersion = &v
}

// GetItems returns the Items field value if set, zero value otherwise.
func (o *TargetList) GetItems() []Target {
...
// and a boolean to check if the value has been set.
func (o *TargetList) GetItemsOk() ([]Target, bool) {
	if o == nil || IsNil(o.Items) {
		return nil, false
	}
	return o.Items, true
...
func (o *TargetList) HasItems() bool {
	if o != nil && !IsNil(o.Items) {
		return true
	}
...
func (o *TargetList) SetItems(v []Target) {
	o.Items = v
}

// GetKind returns the Kind field value if set, zero value otherwise.
func (o *TargetList) GetKind() string {
...
// and a boolean to check if the value has been set.
func (o *TargetList) GetKindOk() (*string, bool) {
	if o == nil || IsNil(o.Kind) {
		return nil, false
	}
	return o.Kind, true
...
func (o *TargetList) HasKind() bool {
	if o != nil && !IsNil(o.Kind) {
		return true
	}
...
func (o *TargetList) SetKind(v string) {
	o.Kind = &v
}

// GetMetadata returns the Metadata field value if set, zero value otherwise.
func (o *TargetList) GetMetadata() V1ListMeta {
...
// and a boolean to check if the value has been set.
func (o *TargetList) GetMetadataOk() (*V1ListMeta, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
func (o *TargetList) HasMetadata() bool {
	if o != nil && !IsNil(o.Metadata) {
		return true
	}
...
func (o *TargetList) SetMetadata(v V1ListMeta) {
	o.Metadata = &v
}
