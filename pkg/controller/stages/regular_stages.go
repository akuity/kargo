...
type ReconcilerConfig struct {
	...
	ReconciliationInterval             time.Duration `envconfig:"STAGE_RECONCILIATION_INTERVAL" default:"5m"`
}
...
func (r *RegularStageReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	return ctrl.Result{RequeueAfter: r.cfg.ReconciliationInterval}, nil
}
